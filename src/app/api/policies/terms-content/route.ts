...
export async function GET() {
  const termsHtml = `
    <div class="prose prose-sm max-w-none">
      <div class="text-neutral-600 mb-6 space-y-1">
      ...
      <section class="mb-6">
        <h2 class="text-xl font-semibold text-neutral-900 mb-3">1. Definitions</h2>
      ...
      <section class="mb-6">
        <h2 class="text-xl font-semibold text-neutral-900 mb-3">2. Scope of Services</h2>
      ...
      <section class="mb-6">
        <h2 class="text-xl font-semibold text-neutral-900 mb-3">3. Visa Disclaimer (IMPORTANT)</h2>
        <ul class="list-disc pl-6 space-y-2 text-neutral-700">
      ...
      <section class="mb-6">
        <h2 class="text-xl font-semibold text-neutral-900 mb-3">4. Payments & Pricing</h2>
        <ul class="list-disc pl-6 space-y-2 text-neutral-700">
      ...
      <section class="mb-6">
        <h2 class="text-xl font-semibold text-neutral-900 mb-3">5. Cancellations & Refunds</h2>
        <ul class="list-disc pl-6 space-y-2 text-neutral-700">
      ...
      <section class="mb-6">
        <h2 class="text-xl font-semibold text-neutral-900 mb-3">6. Intellectual Property & Copyright</h2>
        ...
        <p class="text-neutral-700 leading-relaxed font-semibold">
          Travunited™ is a trademark of Travunited of India Pvt Ltd.
        </p>
      </section>

      <section class="mb-6">
        <h2 class="text-xl font-semibold text-neutral-900 mb-3">7. Limitation of Liability</h2>
        <p class="text-neutral-700 leading-relaxed mb-3">
          Travunited shall not be liable for:
        </p>
        <ul class="list-disc pl-6 space-y-2 text-neutral-700 mb-3">
      ...
      <section class="mb-6">
        <h2 class="text-xl font-semibold text-neutral-900 mb-3">8. Force Majeure</h2>
        <p class="text-neutral-700 leading-relaxed mb-3">
      ...
      <section class="mb-6">
        <h2 class="text-xl font-semibold text-neutral-900 mb-3">9. User Responsibilities</h2>
        <ul class="list-disc pl-6 space-y-2 text-neutral-700">
      ...
      <section class="mb-6">
        <h2 class="text-xl font-semibold text-neutral-900 mb-3">10. Website Usage</h2>
        <ul class="list-disc pl-6 space-y-2 text-neutral-700">
      ...
      <section class="mb-6">
        <h2 class="text-xl font-semibold text-neutral-900 mb-3">11. Modification of Terms</h2>
        <p class="text-neutral-700 leading-relaxed">
      ...
      <section class="mb-6">
        <h2 class="text-xl font-semibold text-neutral-900 mb-3">12. Governing Law & Jurisdiction</h2>
        <p class="text-neutral-700 leading-relaxed">
      ...
      <section class="mb-6">
        <h2 class="text-xl font-semibold text-neutral-900 mb-3">Contact Us</h2>
        <p class="text-neutral-700 leading-relaxed">
