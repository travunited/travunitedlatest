              ...
              <tbody className="bg-white divide-y divide-neutral-200">
                {customers.map((customer) => (
                  <tr key={customer.id} className="hover:bg-neutral-50">
                    ...
                    <td className="px-6 py-4 whitespace-nowrap text-sm text-neutral-900">{formatDate(customer.createdAt)}</td>
                    <td className="px-6 py-4 whitespace-nowrap text-sm text-neutral-900">{formatDate(customer.lastActivity)}</td>
                  </tr>
                ))}
              </tbody>
            </table>
