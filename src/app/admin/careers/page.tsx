...
import { Eye, Filter, Search, Download, CheckCircle, X, Clock, AlertCircle, MoreVertical, Briefcase } from "lucide-react";
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center space-x-3">
            {session?.user?.role === "SUPER_ADMIN" && (
              <Link
                href="/admin/careers/positions"
                className="inline-flex items-center space-x-2 bg-neutral-600 text-white px-4 py-2 rounded-lg font-medium hover:bg-neutral-700 transition-colors"
              >
                <Briefcase size={18} />
