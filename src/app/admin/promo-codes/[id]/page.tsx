...
import { ArrowLeft, Save, Tag, BarChart3 } from "lucide-react";
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        setError(errorData.error || "Failed to update promo code");
      }
    } catch (err) {
    ...
    <AdminLayout>
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="flex items-center justify-between mb-6">
          ...
          <Link
            href={`/admin/promo-codes/${params.id}/analytics`}
        ...
        <div className="bg-white rounded-lg shadow-sm border border-neutral-200 p-8">
          <div className="flex items-center mb-6">
            ...
            <h1 className="text-2xl font-bold text-neutral-900">Edit Promo Code</h1>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="border-b border-neutral-200 pb-6">
              ...
              <div className="mt-4 text-sm text-neutral-600">
                <p>Note: Specific visa/tour/country restrictions can be managed here (advanced feature - to be added).</p>
              </div>
            </div>
