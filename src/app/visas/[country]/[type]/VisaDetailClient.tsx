...
export function VisaDetailClient({ children, searchParams }: VisaDetailClientProps) {
  ...
  const buildBackUrl = () => {
    ...
    return `/visas${queryString ? `?${queryString}` : ""}`;
  };
  ...
  useEffect(() => {
    if (typeof window !== "undefined") {
      ...
      sessionStorage.setItem("visas-back-url", backUrl);
    }
  }, [urlSearchParams]);
